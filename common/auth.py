...
verification. This is intentional during early development while
auth-identity-service is also a scaffold; when real signed tokens arrive, swap
the decode call for a JWKS-backed verifier and no other code changes.
"""
import logging
...
class IsPatientOrReceptionist(_HasRole):
    required_roles = ("patient", "receptionist")
